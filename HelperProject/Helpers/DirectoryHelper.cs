...
namespace HelperProject.Helpers
{
    public class DirectoryHelper
    {
        ...
        public ErrorHandler CreatDirectoryIfNotExists(string path)
        {
            try
            {
                string message;
        ...
        /// <returns>Error Handler object which will tell you if the operation succeeded or not. If not it gives the reason as a message</returns>
        [CheckForNullParameters]
        public ErrorHandler MoveDirectoryIfExists(string sourcePath, string destinationPath)
        {
            try
            {
        ...
        /// <returns>Error Handler object which will tell you if the operation succeeded or not. If not it gives the reason as a message</returns>
        [CheckForNullParameters]
        public ErrorHandler MoveFileIfExists(string fileName, string sourcePath, string destinationPath, bool isForcedMove)
        {
            try
            {
                if (Directory.Exists(sourcePath))
        ...
        /// <returns>Error Handler object which will tell you if the operation succeeded or not. If not it gives the reason as a message</returns>
        [CheckForNullParameters]
        public ErrorHandler DeleteDirectoryIfExists(string path)
        {
            try
            {
                if (Directory.Exists(path))
        ...
        /// <returns>Error Handler object which will tell you if the operation succeeded or not. If not it gives the reason as a message</returns>
        [CheckForNullParameters]
        public ErrorHandler DeleteDirectoryIfEmpty(string path)
        {
            try
            {
                if (Directory.Exists(path))
        ...
        /// <returns>Error Handler object which will tell you if the operation succeeded or not. If not it gives the reason as a message</returns>
        [CheckForNullParameters]
        public ErrorHandler DeleteFileIfExists(string path, string fileName)
        {
            try
            {
                if (Directory.Exists(path))
        ...
        [CheckForNullParameters]
        public ErrorHandler<List<string>> GetAllDirectoriesFromPath(string path)
        {
            try
            {
                if (Directory.Exists(path))
        ...
        /// Access it using Result property of the object returned</returns>
        [CheckForNullParameters]
        public ErrorHandler<List<string>> GetAllFilesFromPath(string path)
        {
            try
            {
                if (Directory.Exists(path))
        ...
        /// Access it using Result property of the object returned</returns>
        [CheckForNullParameters]
        public ErrorHandler<List<string>> SearchDirectoriesFromPath(string path, string searchText, bool searchAsExact)
        {
            try
            {
                if (Directory.Exists(path))
        ...
        /// Access it using Result property of the object returned</returns>
        [CheckForNullParameters]
        public ErrorHandler<List<string>> SearchFilesFromPath(string path, string searchText, bool searchAsExact)
        {
            try
            {
                if (Directory.Exists(path))
        ...
        [CheckForNullParameters]
        public ErrorHandler RenameDirectoryIfExists(string path, string oldName, string newName)
        {
            try
            {
                if (Directory.Exists(path))
        ...
        [CheckForNullParameters]
        public ErrorHandler RenameFileIfExists(string path, string oldFileName, string newFileName)
        {
            try
            {
                if (Directory.Exists(path))
